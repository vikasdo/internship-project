			...
			<div class="col-lg-3 subscribe">
				...
				?>
					<form class="form-vertical" action="db.php" method="post">
						...
						<br>
						<input type="submit" class="btn btn_web form-control" value="Sign Me Up" name="subscribe" onclick="r()">
					</form>
					<div class="text-center col-lg-12">
						...
						<a href="https://www.youtube.com/channel/UCF70NDTnxwcBrAKoWsjicug?view_as=subscriber" target="_blank" style="color:#8a2be2"><i class="fa fa-youtube icon"></i></a>
