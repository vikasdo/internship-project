	...
	<div class="container-fluid cont">
		<div class="row">
			<div class="col-lg-4 col-lg-offset-1">
				<br>
				<h3 class="text"><strong>About Us</strong></h3>
			...
			<div class="col-lg-3">
				<br>
				<h3 style="font-family:Bahnschrift Light"><strong>Contact</strong></h3>
				<hr>
				<div style="font-size:18px">
				<i class="fa fa-home"> Hyderabad,India</i><br>
				<i class="fa fa-envelope"> teamweb@gmail.com</i><br>
				<i class="fa fa-phone"> +91 1234567890</i><br>
				<i class="fa fa-home"> Hyderabad,India.</i>
				</div>
			</div>
